This app is written used Google Web Toolkit framework.
For mor information and gwt installation guide see  official site: http://www.gwtproject.org/
...
To launch your web app in GWT development mode, go to the Run menu and choose:
  ...
  named "imageprocessing".  Select and click "Debug".
